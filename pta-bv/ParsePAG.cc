...
{
	long all_rels = 
	alloc_rel->getRelationSize( ) +
	assign_rel->getRelationSize( ) +
	store_rel->getRelationSize( ) +
	load_rel->getRelationSize( ) +
	decl_type->getRelationSize( ) +
	alloc_type->getRelationSize( ) +
	var_type->getRelationSize( ) ;
